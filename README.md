...
## Emulating the Robot
If you wish to use a virtual robot for testing, you'll need to download a hypervisor such as [VirtualBox](https://www.virtualbox.org/wiki/Downloads) and download the [virtual machine installation](https://s3-eu-west-1.amazonaws.com/ur-support-site/213149/URSim_VIRTUAL-5.12.6.1102099.rar). After downloading, please make sure the network adapter is set to "Bridged". Please follow [this](https://www.youtube.com/watch?v=oJGPTRlTMPM) tutorial if you are stuck.

## Orignal GitHub project
The original project can be [downloaded here](https://github.com/rparak/Unity3D_Robotics_UR?tab=readme-ov-file) and uses an MIT license.
